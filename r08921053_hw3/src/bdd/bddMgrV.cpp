...
BddNodeV
BddMgrV::Restrict(BddNodeV f, BddNodeV c)
{
   if(c==BddNodeV::_zero){
      cerr << "Error: " << endl;
   ...
   return ( (~BddMgrV::getSupport(a)) & Restrict(f.getRightCofactor(a), c.getRightCofactor(a) )) |
          ( (BddMgrV::getSupport(a)) & Restrict(f.getLeftCofactor(a), c.getLeftCofactor(a) ));
}
...
BddMgrV::Restrict(BddNodeV f, BddNodeV c)
{
   ...
   return ( (~BddMgrV::getSupport(a)) & Restrict(f.getLeftCofactor(a), c.getLeftCofactor(a)) ) |
          ( (BddMgrV::getSupport(a)) & Restrict(f.getRightCofactor(a), c.getRightCofactor(a)) );
}
*/
