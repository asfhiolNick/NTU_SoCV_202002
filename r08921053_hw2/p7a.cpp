...
//----------------------------------------------------------------------
BddNode
BddMgr::restrict(BddNode f, BddNode c)
{
   if(c==BddNode::_zero){
      cerr << "Error: " << endl;
   ...
   if(c.getRightCofactor(a)==BddNode::_zero)
      return restrict(f.getLeftCofactor(a), c.getLeftCofactor(a));
   if(c.getLeftCofactor(a)==BddNode::_zero)
   ...
   return ( (~BddMgr::getSupport(a)) & restrict(f.getRightCofactor(a), c.getRightCofactor(a) )) |
          ( (BddMgr::getSupport(a)) & restrict(f.getLeftCofactor(a), c.getLeftCofactor(a) ));
